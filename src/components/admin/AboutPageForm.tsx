      ...
      >
        <span
          style={{
            ...
            transform:
              formData[key] === "true" ? "translateX(20px)" : "translateX(0)",
          }}
        />
      </button>
      <span style={localStyles.toggleStatus}>
        {formData[key] === "true" ? "표시" : "숨김"}
      </span>
    </div>
  );
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} style={localStyles.valueItem}>
                ...
                <input
                  ...
                  value={
                    formData[`about_values_item${i}_title` as keyof FormData]
                  }
                  onChange={handleChange}
                  placeholder="제목"
                ...
                <textarea
                  ...
                  value={
                    formData[`about_values_item${i}_content` as keyof FormData]
                  }
                  onChange={handleChange}
                  placeholder="내용"
                  rows={3}
          ...
          <div style={localStyles.listContainer}>
            {historyItems.map((item) => (
              <div key={item.id} style={localStyles.listItem}>
                <span style={localStyles.listItemDate}>
            ...
            {historyItems.length === 0 && (
              <p style={{ color: "#6b7280" }}>등록된 연혁이 없습니다.</p>
            )}
          </div>
              ...
              <div style={localStyles.modalContent}>
                ...
                >
                  ...
                  <button
                    ...
                    style={localStyles.saveModalBtn}
                  >
                    저장
                  </button>
                </div>
              ...
              <div key={member.id} style={localStyles.teamCard}>
                {member.image_path ? (
                  <img
                    ...
                    alt={member.name}
                    style={localStyles.teamImage}
                  />
                ) : (
                  <div style={localStyles.teamImagePlaceholder}>
                    이미지 없음
                  </div>
                )}
              ...
              <div style={localStyles.modalContent}>
                ...
                <div style={localStyles.imageUpload}>
                  {editingMember.image_path ? (
                    <img
                      src={editingMember.image_path}
                      alt="Preview"
                      style={localStyles.imagePreviewSmall}
                    />
                  ) : (
                    <div style={localStyles.imagePlaceholder}>이미지 없음</div>
                  )}
                  <input
                    ...
                    onChange={(e) =>
                      e.target.files?.[0] &&
                      handleMemberImageUpload(e.target.files[0])
                    }
                  />
                </div>
                <div
