  ...
  return (
    <div className="min-h-screen bg-[#f5f7f7]">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
            ...
            <div className="flex justify-between items-start pb-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {orderData.product.spec?.size} ·{" "}
                  {orderData.product.spec?.quantity}부
                  {orderData.product.spec?.pages &&
                    ` · ${orderData.product.spec.pages}p`}
                </p>
              </div>
              <span className="font-semibold text-gray-900">
        ...
        <a
          href="/"
          className="block w-full py-3.5 bg-gray-900 text-white text-center text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors"
        >
          홈으로 돌아가기
        </a>
      </main>
