...
const ALLOWED_FOLDERS = new Set([
  'uploads', 'papers', 'products', 'news', 'works', 'services',
...
export const POST: APIRoute = async ({ request, cookies }) => {
  try {
    ...
    if (file.type && !ALLOWED_MIME_TYPES.has(file.type)) {
      ...
      const dangerousTypes = ['text/html', 'application/javascript', 'text/javascript', 'application/x-executable'];
    ...
    const finalFolder = ALLOWED_FOLDERS.has(safeFolder) ? safeFolder : 'uploads';
